...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url = "http://ftp.samba.org/pub/samba/stable/${name}.tar.gz";
    sha256 = "1sny3irf1p4fjli5qa29swr3l217grg90cva35rmay48fw7g5g9i";
  };

  buildInputs = [ 
    readline pam openldap popt iniparser libunwind fam acl cups 
    attr docbook_xsl libbsd gnutls pkgconfig python
